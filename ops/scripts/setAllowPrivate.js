...
const inputs = require('../input/setAllowPrivate.json')
...
async function main() {
  console.log('========================================')
  console.log('UPDATING PRIVATE PERMISSION')
  console.log('========================================\n')

  let nonce = await web3Instance.eth.getTransactionCount(RELAYED_OWNER_ACCOUNT_ADDRESS)

  console.log(`\nUpdating private permission for ${inputs.ADDRESS_TO_UPDATE}: `)
  const txData = await permissionContract.methods.setAllowPrivate(inputs.ADDRESS_TO_UPDATE, inputs.ALLOWED).encodeABI({from: RELAYED_OWNER_ACCOUNT_ADDRESS})
